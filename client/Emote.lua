...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Pro přehrání emotu', { { name = "emotename", help = "tanec, kamera, sezení nebo jakákoli platná emoce." } })
    TriggerEvent('chat:addSuggestion', '/emote', 'Pro přehrání emotu', { { name = "emotename", help = "tanec, kamera, sezení nebo jakákoli platná emoce." } })
    ...
    TriggerEvent('chat:addSuggestion', '/emotemenu', 'Zobrazí menu pro emoty.')
    TriggerEvent('chat:addSuggestion', '/emotes', 'Seznam dostupných emotů.')
    TriggerEvent('chat:addSuggestion', '/walk', 'Zvol si svůj styl chůze.', { { name = "style", help = "/walks pro seznam dostupných chůzí" } })
    TriggerEvent('chat:addSuggestion', '/walks', 'Seznam dostupných stylů chůzí.')
end)
