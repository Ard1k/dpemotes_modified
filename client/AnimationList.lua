...
DP.AnimalEmotes = {
--[[     ["1dogattack"] = { "creatures@rottweiler@melee@", "dog_takedown_from_back", "~r~Zautočení", AnimationOptions = {
        EmoteLoop = false
    } },
    ["1dogattack2"] = { "creatures@rottweiler@melee@", "dog_takedown_from_back", "~r~TAKE DOWN", "dog_takedown_from_back", AnimationOptions = {
        EmoteMoving = false,
        EmoteDuration = 3000,
    } }, ]]
    ["1dogbark"] = { "creatures@rottweiler@amb@world_dog_barking@idle_a", "idle_a", "Štěkání", AnimationOptions = {
        EmoteLoop = true
    } },
    ["1dogbark2"] = { "creatures@rottweiler@melee@streamed_taunts@", "taunt_02", "Štěkání a skákání", AnimationOptions = {
        EmoteLoop = true
    } },
    ["2dogsleep"] = { "creatures@rottweiler@amb@sleep_in_kennel@", "sleep_in_kennel", "Lehnout", AnimationOptions = {
        EmoteLoop = true
    } },
    ["3dogsit"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Sednout", AnimationOptions = {
        EmoteLoop = true
    } },
    ["4dogitch"] = { "creatures@rottweiler@amb@world_dog_sitting@idle_a", "idle_a", "Poškrábat se", AnimationOptions = {
        EmoteDuration = 2000
    } },
    ["5dogbeg2"] = { "creatures@rottweiler@tricks@", "paw_right_loop", "Podat tlapku", AnimationOptions = {
        EmoteLoop = true
    } },
    ["6dogbeg"] = { "creatures@rottweiler@tricks@", "beg_loop", "Prosit na dvou tlapkách", AnimationOptions = {
        EmoteLoop = true
    } },
    ["7dogpee"] = { "creatures@rottweiler@move", "pee_left_idle", "Vyčůrat se (do lava)", AnimationOptions = {
        EmoteLoop = false
    } },
    ["8dogpee2"] = { "creatures@rottweiler@move", "pee_right_idle", "Vyčůrat se (do prava)", AnimationOptions = {
        EmoteLoop = false
    } },
    ["9dogdump"] = { "creatures@rottweiler@move", "dump_loop", "Vysrat se", AnimationOptions = {
...
--[[     ["sdogdance"] = { "creatures@pug@move", "idle_turn_0", "Dance (small dog)", AnimationOptions = {
    ...
    ["dogbb"] = { "creatures@pug@move", "nill", "Baseballový míček v tlamě", AnimationOptions = {
        Prop = 'w_am_baseball',
        PropBone = 31086,
        PropPlacement = { 0.1800, -0.000, -0.0450, 0.0, 0.0 },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["dogburger"] = { "creatures@pug@move", "nill", "Burger v tlamě", AnimationOptions = {
    ...
    ["dogcontroller"] = { "creatures@pug@move", "nill", "Herní ovladač v tlamě", AnimationOptions = {
        Prop = 'prop_controller_01',
        PropBone = 31086,
        PropPlacement = {  0.1800, -0.000, -0.0450, -90.0, 0.0, 90.0  },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["dogdolla"] = { "creatures@pug@move", "nill", "Peníze v tlamě (málo)", AnimationOptions = {
...
--[[     ["dogdolla2"] = { "creatures@pug@move", "nill", "Dollar Bill Scrunched  (small dog)", AnimationOptions = {
    ...
    ["dogdolla3"] = { "creatures@pug@move", "nill", "Peníze v tlamě (hodně)", AnimationOptions = {
        Prop = 'bkr_prop_money_wrapped_01',
        PropBone = 31086,
        PropPlacement = {  0.1800, -0.000, -0.0450, 0.0, 0.0, 90.0  },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["dogdolla4"] = { "creatures@pug@move", "nill", "Malá kapsa na hlavě", AnimationOptions = {
        Prop = 'ch_prop_ch_moneybag_01a',
        PropBone = 31086,
        PropPlacement = { 0.050, -0.000, 0.100, 0.0, 0.0 },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["dogmic"] = { "creatures@pug@move", "nill", "Mikrofon v tlamě", AnimationOptions = {
        Prop = 'p_ing_microphonel_01',
        PropBone = 31086,
        PropPlacement = {  0.1800, -0.050, -0.0450, 90.0, 0.0  },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
--[[     ["sdogteddy"] = { "creatures@pug@move", "nill", "Teddy (small dog)", AnimationOptions = {
        ...
        PropBone = 31086,
        PropPlacement = { 0.1500, -0.0, -0.23, 0.000, -0.0000, 90.0000 },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["sdogteddy2"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Teddy 2 (small dog)", AnimationOptions = {
        Prop = 'v_ilev_mr_rasberryclean',
        PropBone = 31086,
        PropPlacement = { 0.1500, -0.0, -0.23, 0.000, -0.0000, 90.0000 },
        EmoteLoop = true,
    ...
    ["dogtennis"] = { "creatures@pug@move", "nill", "Tenisový míč v tlamě", AnimationOptions = {
    ...
    ["dogtennisr"] = { "creatures@pug@move", "nill", "Tenisová raketa v tlamě", AnimationOptions = {
        Prop = 'prop_tennis_rack_01',
        PropBone = 31086,
        PropPlacement = { 0.1800, 0.150, -0.0450, 90.0, 0.0 },
        EmoteLoop = true,
        EmoteMoving = false,
    }
    },
    ["dogrose"] = { "creatures@pug@move", "nill", "Rouže v tlamě", AnimationOptions = {
    ...
    ["dogrose2"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Rouže v tlamě (Sednout)", AnimationOptions = {
        Prop = 'prop_single_rose',
        PropBone = 12844,
        PropPlacement = { 0.1800, -0.050, -0.0450, 90.0, 0.0 },
        EmoteLoop = true,
    ...
    ["doggoldengun"] = { "creatures@pug@move", "nill", "Zlatá zbraň v tlamě", AnimationOptions = {
        Prop = 'w_pi_pistol_luxe',
        PropBone = 12844,
        PropPlacement = { 0.1800, -0.000, -0.0450, 90.0, 20.0, -55.0 },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["doggoldengun2"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Zlatá zbraň v tlamě (Sednout)", AnimationOptions = {
        Prop = 'w_pi_pistol_luxe',
        PropBone = 12844,
        PropPlacement = { 0.1800, -0.000, -0.0450, 90.0, 20.0, -55.0 },
        EmoteLoop = true,
    ...
    ["dogstun"] = { "creatures@pug@move", "nill", "Taser v tlamě", AnimationOptions = {
        Prop = 'w_pi_stungun',
        PropBone = 12844,
        PropPlacement = { 0.1800, -0.000, -0.0450, 90.0, 20.0, -55.0 },
        EmoteLoop = true,
    ...
    ["doggl1"] = { "creatures@pug@move", "nill", "Pilotní brýle na očích", AnimationOptions = {
        Prop = 'prop_aviators_01',
        PropBone = 31086,
        PropPlacement = { 0.090, -0.000, 0.053, 0.0, 0.0, 90.0 },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["doggl2"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Pilotní brýle na očích (Sednout)", AnimationOptions = {
        Prop = 'prop_aviators_01',
        PropBone = 31086,
        PropPlacement = { 0.090, -0.000, 0.053, 0.0, 0.0, 90.0 },
        EmoteLoop = true,
    ...
    ["doggl3"] = { "creatures@pug@move", "nill", "Sluneční brýle na očích", AnimationOptions = {
    ...
    ["doggl4"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Sluneční brýle na očích (Sednout)", AnimationOptions = {
        Prop = 'prop_cs_sol_glasses',
        PropBone = 31086,
        PropPlacement = { 0.090, -0.000, 0.053, 0.0, 0.0, 90.0 },
        EmoteLoop = true,
    ...
    ["doghd1"] = { "creatures@pug@move", "nill", "Hotdog v tlamě", AnimationOptions = {
        Prop = 'prop_cs_hotdog_01',
        PropBone = 31086,
        PropPlacement = { 0.1800, -0.000, -0.0450, 0.0, 0.0, 0.0 },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["doghd2"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Hotdog v tlamě (Sednout)", AnimationOptions = {
        Prop = 'prop_cs_hotdog_01',
        PropBone = 31086,
        PropPlacement = {0.1800, -0.000, -0.0450, 0.0, 0.0, 0.0},
        EmoteLoop = true,
    ...
    ["doghlmt1"] = { "creatures@pug@move", "nill", "Motorkařská helma na hlavě", AnimationOptions = {
        Prop = 'ba_prop_battle_sports_helmet',
        PropBone = 31086,
        PropPlacement = {0.0, -0.000, -0.0450, 0.0, 0.0, 90.0},
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["doghlmt2"] = { "creatures@pug@move", "nill", "Stavbarská helma na hlavě", AnimationOptions = {
        Prop = 'prop_hard_hat_01',
        PropBone = 31086,
        PropPlacement = {0.045, -0.000, 0.120, 0.0, 0.0, 90.0},
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["doghat"] = { "creatures@pug@move", "nill", "Klobouk na hlavě s brýlemi", AnimationOptions = {
        Prop = 'prop_proxy_hat_01',
        PropBone = 31086,
        PropPlacement = { 0.0, 0.0, 0.10, -99.8510766, 80.1489234, 90.7279411 },
        SecondProp = 'prop_aviators_01',
        SecondPropBone = 31086,
        SecondPropPlacement = { 0.090, -0.000, 0.053, 0.0, 0.0, 90.0 },
        EmoteLoop = true,
        EmoteMoving = false,
    } },
    ["doghat2"] = { "creatures@rottweiler@amb@world_dog_sitting@base", "base", "Klobouk na hlavě s brýlemi (Sednout)", AnimationOptions = {
        Prop = 'prop_proxy_hat_01',
        PropBone = 31086,
        PropPlacement = { 0.0, 0.0, 0.10, -99.8510766, 80.1489234, 90.7279411 },
        SecondProp = 'prop_aviators_01',
    ...
    ["dogsteak"] = { "creatures@pug@move", "nill", "steak v tlamě", AnimationOptions = {
        Prop = 'prop_cs_steak',
        PropBone = 31086,
        PropPlacement = { 0.1800, -0.000, -0.0450, 0.0, 0.0 },
        EmoteLoop = true,
    ...
    ["dogsteak2"] = { "creatures@rottweiler@amb@sleep_in_kennel@", "sleep_in_kennel", "steak v tlamě (Lehnout)", AnimationOptions = {
        Prop = 'prop_cs_steak',
        PropBone = 31086,
        PropPlacement = { 0.1800, -0.000, -0.0450, 0.0, 0.0 },
        EmoteLoop = true,
